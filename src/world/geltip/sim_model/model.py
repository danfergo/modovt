...
from .utils.camera import get_camera_matrix, get_cloud_from_depth, depth2cloud
...
class SimulationModel:
    ...
    def load_assets(assets_path, input_res, output_res, lf_method, n_light_sources):
        ...
        cloud = cloud.reshape((input_res[0], input_res[1], 3))
        cloud = cv2.resize(cloud, output_res[::-1])
